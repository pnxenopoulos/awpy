...
def player_stats(game_rounds, return_type="json", selected_side="all"):
    ...
    for r in game_rounds:
        ...
        for w in r["weaponFires"]:
            ...
            if fire_key in player_statistics.keys() and w["playerSide"] in active_sides:
        ...
        for f in r["flashes"]:
            ...
            if (
                f["attackerSteamID"]
                and flasher_key in player_statistics.keys()
        ...
        for g in r["grenades"]:
            ...
            if (
                g["throwerSteamID"]
                and thrower_key in player_statistics.keys()
