...
def parse_frame(tick_df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Updating 'game_phase'
    game_phase_map = {
        0: "init", 1: "pregame", 2: "startgame", 3: "preround",
        4: "teamwin", 5: "restart", 6: "stalemate", 7: "gameover"
    }
    tick_df["game_phase"] = tick_df["game_phase"].replace(game_phase_map)

    # Selecting relevant columns
    relevant_columns = [
        "tick", "game_phase", "player", "steamid", "clan", "side", "X", "Y", "Z",
        "pitch", "yaw", "last_place", "is_alive", "health", "armor", "has_helmet",
        "has_defuser", "active_weapon", "current_equip_value",
        "round_start_equip_value", "rank", "ping", "flash_duration",
        "flash_max_alpha", "is_scoped", "is_defusing", "is_walking",
        "is_strafing", "in_buy_zone", "in_bomb_zone", "spotted"
    ]
...
def create_empty_tick_df() -> pd.DataFrame:
    columns = [
        "tick", "game_phase", "side", "steamid", "in_buy_zone", "rank", "ping",
        "is_strafing", "Y", "player", "last_place", "in_bomb_zone", "X", "spotted",
        "is_walking", "active_weapon", "Z", "is_alive", "flash_duration", "health",
        "armor", "is_scoped", "pitch", "is_defusing", "current_equip_value",
        "yaw", "clan", "flash_max_alpha", "round_start_equip_value"
    ]
