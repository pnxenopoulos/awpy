...
class PlayerData(Enum):
    ...
    HAS_CONTROLLED_BOT_THIS_ROUND = "has_controlled_bot_this_round"  # m_bHasControlledBotThisRound
    ...
    WEAPON_PURCHASES_THIS_MATCH = "weapon_purchases_this_match" # m_iWeaponPurchasesThisMatch
    WEAPON_PURCHASES_THIS_ROUND = "weapon_purchases_this_round" # m_iWeaponPurchasesThisRound
    ...
    BLOCKING_USE_IN_PROGESS = "blocking_use_in_progess" # m_iBlockingUseActionInProgress
    ...
    GROUND_ACCEL_LINEAR_FRAC_LAST_TIME = "ground_accel_linear_frac_last_time" # m_flGroundAccelLinearFracLastTime
