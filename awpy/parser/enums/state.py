...
class GameState(Enum):
    ...
    TERRORIST_TIMEOUT_REMAINING = "terrorist_timeout_remaining" # m_flTerroristTimeOutRemaining
    ...
    TIME_UNTIL_NEXT_PHASE_START = "time_until_next_phase_start" # m_timeUntilNextPhaseStarts
