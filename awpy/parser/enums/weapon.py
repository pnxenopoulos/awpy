...
class Weapon(Enum):
    ...
    ECON_ITEM_ATTRIBUTE_DEF_IDX = "econ_item_attribute_def_idx" # m_iAttributeDefinitionIndex
    ...
    FIRE_SEQ_START_TIME_CHANGE = "fire_seq_start_time_change" # m_nFireSequenceStartTimeChange
    IS_PLAYER_FIRE_EVENT_PRIMARY = "is_player_fire_event_primary" # m_bPlayerFireEventIsPrimary
    ...
    TIME_SILENCER_SWITCH_COMPLETE = "time_silencer_switch_complete" # m_flTimeSilencerSwitchComplete
    ...
    NEXT_PRIMARY_ATTACK_TICK_RATIO = "next_primary_attack_tick_ratio" # m_flNextPrimaryAttackTickRatio
    NEXT_SECONDARY_ATTACK_TICK = "next_secondary_attack_tick" # m_nNextSecondaryAttackTick
    NEXT_SECONDARY_ATTACK_TICK_RATIO = "next_secondary_attack_tick_ratio" # m_flNextSecondaryAttackTickRatio