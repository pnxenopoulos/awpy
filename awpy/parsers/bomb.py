...
def parse_bomb(events: dict[str, pl.DataFrame], valid_ticks: pl.Series) -> pl.DataFrame:
    ...
    bomb_dropped = awpy.parsers.utils.get_event_from_parsed_events(events, "bomb_dropped")
    bomb_pickup = awpy.parsers.utils.get_event_from_parsed_events(events, "bomb_pickup")
    bomb_planted = awpy.parsers.utils.get_event_from_parsed_events(events, "bomb_planted")
    bomb_exploded = awpy.parsers.utils.get_event_from_parsed_events(events, "bomb_exploded")
    bomb_defused = awpy.parsers.utils.get_event_from_parsed_events(events, "bomb_defused")
